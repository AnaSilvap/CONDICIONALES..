...
let nota2
let nota3
do{nota1 = Number(prompt("Ingrese su primera nota"))
}while(isNaN(nota1)||nota1<0||nota1>10)
do{nota2 = Number(prompt("Ingrese su segunda nota"))
}while(isNaN(nota2)||nota2<0||nota2>10)
do{nota3 = Number(prompt("Ingrese su tercera nota"))
}while(isNaN(nota3)||nota3<0||nota3>10)
let p = ((nota1)+(nota2)+(nota3))/3;
